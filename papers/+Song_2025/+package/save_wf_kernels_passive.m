...
save_path = '\\qnap-ap001.dpag.ox.ac.uk\APlab\Lab\Papers\Song_2025\data\revision';
...
for  workflow_idx=1:2
    ...
    for curr_group=1:2
        ...
        for curr_animal=1:length(animals{curr_group})
            ...
            raw_data_passive.workflow_type_name_merge=...
                cellfun(@(x) workflow_name_map(x),raw_data_passive.workflow_type_name,'UniformOutput',false);
