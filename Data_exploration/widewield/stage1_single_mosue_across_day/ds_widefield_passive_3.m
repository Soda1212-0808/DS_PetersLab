...
for x=1
    if x==1
        % animals = {'AP028','AP029'};type_seq=1; %v-a
        % animals = {'HA003','HA004','AP028','AP029','AP027'};type_seq=1; %v-a
        animals = {'DS007','DS010','AP019','AP021','DS011','AP022','DS001','AP018','AP020', 'DS003','DS006','DS013','DS000','DS004','DS014','DS015','DS016','HA004','HA003','AP027','AP028','AP029'};

    else animals = {'DS013'};type_seq=2; %a-v
    end
    ...
    for curr_passive=2
        ...
        for curr_animal_idx=1:length(animals)
            ...
            if     exist ([Path '\' passive_workflow '\' animal '_' passive_workflow '.mat' ])==2
                ...
                workflow_type_name=cell(length(recordings),1);
                workflow_type_name_merge=cell(length(recordings),1);
            ...
            if ~(file_length==length(recordings)&problem==0)
                ...
                for curr_recording =file_length:length(recordings)
                    ...
                    workflow_type_name{curr_recording}=recordings2(task_day_index).workflow{index_real};
                    ...
                    elseif  strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage1')...
                            ||strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage2')...
                    ...
                    if strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage1_audio_volume')...
                            ||strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage2_audio_volume')
                        workflow_type_name_merge{curr_recording}='audio volume';
                    elseif strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage1')...
                            ||strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage2')
                        workflow_type_name_merge{curr_recording}='visual position';
                    elseif strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage1_size_up')...
                            ||strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage2_size_up')
                        workflow_type_name_merge{curr_recording}='visual size up';
                    elseif strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage1_opacity')...
                            ||strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage2_opacity')
                        workflow_type_name_merge{curr_recording}='visual opacity';
                    elseif strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage1_audio_frequency')...
                            ||strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage2_audio_frequency')
                        workflow_type_name_merge{curr_recording}='audio volume';
                    elseif strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_stage2_mixed_VA')...
                            ||strcmp(recordings2(task_day_index).workflow{index_real},'stim_wheel_right_frequency_stage2_mixed_VA')
